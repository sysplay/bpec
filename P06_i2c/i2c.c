...
#define SCLK 48 // System Clock in MHz
	 ...
	 * 1/200K = tLow = (SCLL + 7) * 1/ICLK => SCLL = ???
	 * 1/200K = tHigh = (SCLH + 5) * 1/ICLK => SCLH = ???
	 * 1/800K = tLow = (SCLL + 7) * 1/ICLK => SCLL = ???
	 * 1/800K = tHigh = (SCLH + 5) * 1/ICLK => SCLH = ???
	 */
	if (mode == standard)
	{
		I2C0_SCLL = 0 /* TODO 2A: Compute & Fill */;
		I2C0_SCLH = 0 /* TODO 2B: Compute & Fill */;
	}
	else if (mode == fast)
	{
		I2C0_SCLL = 0 /* TODO 3A: Compute & Fill */;
		I2C0_SCLH = 0 /* TODO 3B: Compute & Fill */;
	}
